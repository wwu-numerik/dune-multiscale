...
#@ energy_policy_tag = et_8x8_4N_1C
...
#@ initialdir = $(home)/multiscale-build/dune-multiscale
...
-global.datadir $HOME/multiscale-build-phase2/dune-multiscale/speedup_n112_8x8_T1\
-grids.macro_cells_per_dim 8 -grids.micro_cells_per_macrocell_dim 8 -threading.max_count 1 "
mpiexec ${MPI} -n 112 $BIN ${OPT}
