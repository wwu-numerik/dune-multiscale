...
#@ energy_policy_tag = et_20x20_19N_1C
...
##                    1 h 20 min 30 secs
#@ job_name = msfem_20x20_19N_1C
#@ network.MPI = sn_all,not_shared,us
#@ initialdir = $(home)/multiscale-build-phase2/dune-multiscale
#@ output = job_msfem_20x20_19N_1C_$(jobid).out
#@ error = job_msfem_20x20_19N_1C_$(jobid).err
#@ notification=always
...
-global.datadir $HOME/multiscale-build-phase2/dune-multiscale/speedup_n532_20x20_T1 \
