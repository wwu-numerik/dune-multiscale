...
#@ energy_policy_tag = et_16x16_10N_1C
...
##                    1 h 20 min 30 secs
#@ job_name = msfem_16x16_10N_1C
#@ network.MPI = sn_all,not_shared,us
#@ initialdir = $(home)/multiscale-build-phase2/dune-multiscale
#@ output = job_msfem_16x16_10N_1C_$(jobid).out
#@ error = job_msfem_16x16_10N_1C_$(jobid).err
#@ notification=always
...
-global.datadir $HOME/multiscale-build-phase2/dune-multiscale/speedup_n280_16x16_T1 \
-grids.macro_cells_per_dim 16 -grids.micro_cells_per_macrocell_dim 16 -threading.max_count 1 "
mpiexec ${MPI} -n 256 $BIN ${OPT}