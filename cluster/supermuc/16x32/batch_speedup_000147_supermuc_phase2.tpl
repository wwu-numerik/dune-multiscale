...
#@ energy_policy_tag = et_32x8_147N_1C
...
-global.datadir $HOME/multiscale-build-phase2/dune-multiscale/speedup_n4116_32x8_T1 \
-grids.macro_cells_per_dim 32 -grids.micro_cells_per_macrocell_dim 8 -threading.max_count 1 "
mpiexec ${MPI} -n 4096 $BIN ${OPT}
