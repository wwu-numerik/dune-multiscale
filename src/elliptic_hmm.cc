...
typedef GridFunctionAdapter< ExactSolutionType, GridPartType > DiscreteExactSolutionType;     // for data output with
                                                                                              // paraview or grape
...
typedef LagrangeDiscreteFunctionSpace< FunctionSpaceType, PeriodicGridPartType, 1 > // 1 =POLORDER
...
typedef DiscreteEllipticHMMOperator< DiscreteFunctionType, PeriodicDiscreteFunctionType, DiffusionType,
...
void algorithm(std::string& UnitCubeName,
  ...
  // Leben tun alle diese Funktionen auf dem Makrogitter mit 10 Verfeinerungsleveln, wenn sie auf einem groeberen Gitter
  // bestimmt worden sind, dann wurden sie spaeter darauf projeziert
  // ! TODO hier werden gut 200 zeilen ausgeblendet
  {
    #if 0
    ...
    // discFunc_location_1 =
    // "data/HMM/Model_Problem_1/Macro_10_Micro_8_tolerance3.5e-06/hmm_solution_discFunc_refLevel_10";
    ...
    // discFunc_location_1 =
    // "data/HMM/Model_Problem_2/reference_solution_ref_16/finescale_solution_discFunc_refLevel_16";
    ...
    // discFunc_location_1 =
    // "data/HMM/Model_Problem_2/Macro_4_Micro_10_STRANGE_OVERSAMPLING_TFR/hmm_solution_discFunc_refLevel_4";
    ...
    // discFunc_location_2 =
    // "data/HMM/Model_Problem_1/reference_solution_ref_18/finescale_solution_discFunc_refLevel_18";
    ...
    // discFunc_location_2 =
    // "data/HMM/Model_Problem_2/Macro_2_Micro_8_STRANGE_OVERSAMPLING/hmm_solution_discFunc_refLevel_2";
    // discFunc_location_2 = "data/HMM/Model_Problem_2/Macro_4_Micro_4/hmm_solution_discFunc_refLevel_4";
    // discFunc_location_2 =
    // "data/HMMModel_Problem_2/zzz_inProgress/done/DELTA_0.1_EPSILON_0.05/Macro_8_Micro_10/hmm_solution_discFunc_refLevel_8";
    ...
    DataOutputType discrete_function_1_dataoutput_vorher(grid_1,
                                                         discrete_function_1_series_vorher,
                                                         outputparam_1_vorher);
    ...
    RangeType difference_L2_alternative = 0.0;             // !improved_l2error.norm_L2<2 * DiscreteFunctionSpaceType ::
                                                           // polynomialOrder + 2>( discrete_function_2,
                                                           // discrete_function_1 );
    RangeType norm_L2_function_2 = l2error_test.norm2< 2* DiscreteFunctionSpaceType::polynomialOrder + 2 >(
      zero_function_2,
      discrete_function_2);
    RangeType difference_L2_test = 0.0;             // !improved_l2error.norm_L2<2 * DiscreteFunctionSpaceType ::
                                                    // polynomialOrder + 2>( discrete_function_1, discrete_function_2 );

    RangeType difference_L2 = improved_l2error.norm_adaptive_grids_2< 2* DiscreteFunctionSpaceType::polynomialOrder + 2 >(
      discrete_function_1,
      discrete_function_2);
  ...
  #endif
  #endif   // if not defined LINEAR_PROBLEM
