    ...
    for (unsigned int i = 0; i < numMacroBaseFunctions; ++i)
    {
      for (unsigned int j = 0; j < numMacroBaseFunctions; ++j)
      {
             ...
             ++local_grid_it)
        {
          ...
          FineEntityPointer fine_entity_pointer_1 = coarseDiscreteFunctionSpace_.grid().template getHostEntity< 0 >(
            coarse_grid_entity);
          FineEntityPointer fine_entity_pointer_2 = localDiscreteFunctionSpace.grid().template getHostEntity< 0 >(
            local_grid_entity);
          ...
          {
            // std :: cout << "fine_entity_pointer_1->geometry().corner(0) = " <<
            // fine_entity_pointer_1->geometry().corner(0) << std :: endl;
            // std :: cout << "fine_entity_pointer_1->geometry().corner(1) = " <<
            // fine_entity_pointer_1->geometry().corner(1) << std :: endl;
            // std :: cout << "fine_entity_pointer_1->geometry().corner(2) = " <<
            // fine_entity_pointer_1->geometry().corner(2) << std :: endl;
            // std :: cout << "fine_entity_pointer_2->geometry().corner(0) = " <<
            // fine_entity_pointer_2->geometry().corner(0) << std :: endl;
            // std :: cout << "fine_entity_pointer_2->geometry().corner(1) = " <<
            // fine_entity_pointer_2->geometry().corner(1) << std :: endl;
            // std :: cout << "fine_entity_pointer_2->geometry().corner(2) = " <<
            // fine_entity_pointer_2->geometry().corner(2) << std :: endl << std :: endl;
            continue;
          }
...
// ! loeschen:
  ...
  {
    const CoarseEntity& coarse_grid_entity = *coarse_grid_it;
    FineEntityPointer fine_entity_pointer = coarseDiscreteFunctionSpace_.grid().template getHostEntity< 0 >(
      coarse_grid_entity);
