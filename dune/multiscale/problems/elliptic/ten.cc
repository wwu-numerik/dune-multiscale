...
void Dune::Multiscale::Problem::Ten::Diffusion::diffusiveFlux(const Dune::Multiscale::Problem::Ten::Diffusion::DomainType &x, const Dune::Multiscale::Problem::Ten::Diffusion::JacobianRangeType &gradient, Dune::Multiscale::Problem::Ten::Diffusion::JacobianRangeType &flux) const {
...
void Dune::Multiscale::Problem::Ten::Diffusion::jacobianDiffusiveFlux(const Dune::Multiscale::Problem::Ten::Diffusion::DomainType &x, const Dune::Multiscale::Problem::Ten::Diffusion::JacobianRangeType &, const Dune::Multiscale::Problem::Ten::Diffusion::JacobianRangeType &direction_gradient, Dune::Multiscale::Problem::Ten::Diffusion::JacobianRangeType &flux) const {
  double diff_coef = 0.0;
...
void Dune::Multiscale::Problem::Ten::ExactSolution::evaluate(const Dune::Multiscale::Problem::Ten::ExactSolution::DomainType &, Dune::Multiscale::Problem::Ten::ExactSolution::RangeType &) const {
...
void Dune::Multiscale::Problem::Ten::ExactSolution::evaluate(const Dune::Multiscale::Problem::Ten::ExactSolution::DomainType &x, const Dune::Multiscale::Problem::Ten::ExactSolution::TimeType &, Dune::Multiscale::Problem::Ten::ExactSolution::RangeType &y) const {
  evaluate(x, y);
}
