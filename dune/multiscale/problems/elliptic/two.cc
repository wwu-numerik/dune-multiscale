...
void Dune::Multiscale::Problem::Two::Diffusion::diffusiveFlux(const Dune::Multiscale::Problem::Two::Diffusion::DomainType &x, const Dune::Multiscale::Problem::Two::Diffusion::JacobianRangeType &gradient, Dune::Multiscale::Problem::Two::Diffusion::JacobianRangeType &flux) const {
...
void Dune::Multiscale::Problem::Two::Diffusion::jacobianDiffusiveFlux(const Dune::Multiscale::Problem::Two::Diffusion::DomainType &x, const Dune::Multiscale::Problem::Two::Diffusion::JacobianRangeType &, const Dune::Multiscale::Problem::Two::Diffusion::JacobianRangeType &direction_gradient, Dune::Multiscale::Problem::Two::Diffusion::JacobianRangeType &flux) const {
...
void Dune::Multiscale::Problem::Two::ExactSolution::evaluate(const Dune::Multiscale::Problem::Two::ExactSolution::DomainType &, Dune::Multiscale::Problem::Two::ExactSolution::RangeType &) const {
  DUNE_THROW(Dune::NotImplemented, "Exact solution not available!");
}

void Dune::Multiscale::Problem::Two::ExactSolution::jacobian(const Dune::Multiscale::Problem::Two::ExactSolution::DomainType &, Dune::Multiscale::Problem::Two::ExactSolution::JacobianRangeType &) const {
  DUNE_THROW(Dune::NotImplemented, "Exact solution not available!");
}
