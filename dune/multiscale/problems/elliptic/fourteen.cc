...
void Dune::Multiscale::Problem::Fourteen::ExactSolution::evaluate(const Dune::Multiscale::Problem::Fourteen::ExactSolution::DomainType &, Dune::Multiscale::Problem::Fourteen::ExactSolution::RangeType &) const {
  DUNE_THROW(Dune::NotImplemented, "Exact solution not available!");
}

void Dune::Multiscale::Problem::Fourteen::ExactSolution::jacobian(const Dune::Multiscale::Problem::Fourteen::ExactSolution::DomainType &, Dune::Multiscale::Problem::Fourteen::ExactSolution::JacobianRangeType &) const {
  DUNE_THROW(Dune::NotImplemented, "Exact solution not available!");
}

void Dune::Multiscale::Problem::Fourteen::ExactSolution::evaluate(const Dune::Multiscale::Problem::Fourteen::ExactSolution::DomainType &x, const Dune::Multiscale::Problem::Fourteen::ExactSolution::TimeType &, Dune::Multiscale::Problem::Fourteen::ExactSolution::RangeType &y) const {
  evaluate(x, y);
}
