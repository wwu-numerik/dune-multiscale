...
void Dune::Multiscale::Problem::Example::FirstSource::evaluate(const Dune::Multiscale::Problem::Example::FirstSource::DomainType &x, Dune::Multiscale::Problem::Example::FirstSource::RangeType &y) const {
...
void Dune::Multiscale::Problem::Example::Diffusion::diffusiveFlux(const Dune::Multiscale::Problem::Example::Diffusion::DomainType &, const Dune::Multiscale::Problem::Example::Diffusion::JacobianRangeType &direction, Dune::Multiscale::Problem::Example::Diffusion::JacobianRangeType &flux) const {
...
void Dune::Multiscale::Problem::Example::Diffusion::jacobianDiffusiveFlux(const Dune::Multiscale::Problem::Example::Diffusion::DomainType &, const Dune::Multiscale::Problem::Example::Diffusion::JacobianRangeType &, const Dune::Multiscale::Problem::Example::Diffusion::JacobianRangeType &direction_gradient, Dune::Multiscale::Problem::Example::Diffusion::JacobianRangeType &flux) const {
...
void Dune::Multiscale::Problem::Example::ExactSolution::evaluate(const Dune::Multiscale::Problem::Example::ExactSolution::DomainType &x, Dune::Multiscale::Problem::Example::ExactSolution::RangeType &y) const {
  // u( x_1, x_2 ) = sin( 2 π x_1 ) · sin( 2 π x_2 )
  y = sin(2.0 * M_PI * x[0]) * sin(2.0 * M_PI * x[1]);

}

void Dune::Multiscale::Problem::Example::ExactSolution::evaluate(const Dune::Multiscale::Problem::Example::ExactSolution::DomainType &x, const Dune::Multiscale::Problem::Example::ExactSolution::TimeType &, Dune::Multiscale::Problem::Example::ExactSolution::RangeType &y) const {
  evaluate(x, y);
}
