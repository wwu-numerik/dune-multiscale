...
void Diffusion::diffusiveFlux(const DomainType& /*x*/, const JacobianRangeType& direction,
  ...
  const double a_0_0 = 3.0;
  const double a_0_1 = 0.0;
  const double a_1_0 = 0.0;
  const double a_1_1 = 3.0;
...
void ExactSolution::jacobian(const DomainType& x, JacobianRangeType& grad_u) const {
