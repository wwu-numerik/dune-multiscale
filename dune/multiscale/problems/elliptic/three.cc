...
void Dune::Multiscale::Problem::Three::Diffusion::diffusiveFlux(const Dune::Multiscale::Problem::Three::Diffusion::DomainType &x, const Dune::Multiscale::Problem::Three::Diffusion::JacobianRangeType &gradient, Dune::Multiscale::Problem::Three::Diffusion::JacobianRangeType &flux) const {
...
void Dune::Multiscale::Problem::Three::Diffusion::jacobianDiffusiveFlux(const Dune::Multiscale::Problem::Three::Diffusion::DomainType &x, const Dune::Multiscale::Problem::Three::Diffusion::JacobianRangeType &position_gradient, const Dune::Multiscale::Problem::Three::Diffusion::JacobianRangeType &direction_gradient, Dune::Multiscale::Problem::Three::Diffusion::JacobianRangeType &flux) const {
  double coefficient = 1.0 + (9.0 / 10.0) * sin(2.0 * M_PI * sqrt( fabs(2.0 * x[0]) ) / constants().epsilon) * sin(
        2.0 * M_PI * pow(1.5 * x[1], 2.0) / constants().epsilon);
...
void Dune::Multiscale::Problem::Three::ExactSolution::evaluate(const Dune::Multiscale::Problem::Three::ExactSolution::DomainType &, Dune::Multiscale::Problem::Three::ExactSolution::RangeType &) const {
  DUNE_THROW(Dune::NotImplemented, "Exact solution not available!");
}

void Dune::Multiscale::Problem::Three::ExactSolution::evaluateJacobian(const Dune::Multiscale::Problem::Three::ExactSolution::DomainType &, Dune::Multiscale::Problem::Three::ExactSolution::JacobianRangeType &) const {
  DUNE_THROW(Dune::NotImplemented, "Exact solution not available!");
}

void Dune::Multiscale::Problem::Three::ExactSolution::evaluate(const Dune::Multiscale::Problem::Three::ExactSolution::DomainType &x, const Dune::Multiscale::Problem::Three::ExactSolution::TimeType &, Dune::Multiscale::Problem::Three::ExactSolution::RangeType &y) const {
  evaluate(x, y);
}
