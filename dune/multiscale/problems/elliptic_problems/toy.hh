...
template< class FunctionSpaceImp >
class SecondSource
  : public Fem::Function< FunctionSpaceImp, SecondSource< FunctionSpaceImp > >
{
public:
...
public:
  ...
  inline explicit SecondSource(const FunctionSpaceType& functionSpace, const DiffusionType& diffusion, const int& j)
  ...
  inline void evaluate(const int i, const DomainType& y,
    ...
    diffusion_.diffusiveFlux(y, direction, flux);

    // diffusion_.evaluate( i, j_, y, z);
    z = -flux[0][i];
  } // evaluate
};
