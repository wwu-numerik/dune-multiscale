...
namespace Problem
{
  ...
  public:
    ...
    inline double rand_log_normal(float &m, float &s) const
    {
     ...
     // m is a real number
     // s is a postiv real number. s is a meassure for the variance. The smaller s, the smaller the variance from the expected value
     ...
     do 
      {
       ...
       if (random_number_1 > random_number_2)
         {x1 = (2.0 *(random_number_2 / random_number_1)) - 1.0;}
       else 
       ...
       if (random_number_3 > random_number_2)
         {x2 = (2.0 * (random_number_2 / random_number_3)) - 1.0;}
       else
