...
const Dune::Multiscale::MsFEM::WeightedClementOperator::PreconditionMatrixType &Dune::Multiscale::MsFEM::WeightedClementOperator::preconditionMatrix() const {
...
const Dune::Multiscale::MsFEM::WeightedClementOperator::DiscreteFunctionSpaceType &Dune::Multiscale::MsFEM::WeightedClementOperator::discreteFunctionSpace() const {
    return discreteFunctionSpace_;
}

const Dune::Multiscale::MsFEM::WeightedClementOperator::LinearOperatorType &Dune::Multiscale::MsFEM::WeightedClementOperator::systemMatrix() const {
