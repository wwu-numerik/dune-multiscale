...
public:
  inline explicit ReducedBasisCommDataHandle(DiscreteFunctionType& function)
    : function_(&function)
  {}

  inline ReducedBasisCommDataHandle(const ThisType& other)
...
#endif // ifndef DUNE_FEM_REDUCEDBASISSPACE_COMMHANDLE_HH
