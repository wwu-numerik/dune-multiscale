...
template< class BaseFunction >
inline void ReducedBasisSpace< BaseFunction >::baseFunction(unsigned int i, BaseFunctionType& ret) const {
  baseFunctionList_.getFunc(i, ret);
}

template< class BaseFunction >
inline void ReducedBasisSpace< BaseFunction >::setBaseFunction(unsigned int i, BaseFunctionType& arg) {
  baseFunctionList_.setFunc(i, arg);
}

template< class BaseFunction >
inline const typename ReducedBasisSpace< BaseFunction >::BaseFunctionSpaceType& ReducedBasisSpace< BaseFunction >::
  baseFunctionSpace() const {
...
inline OutStreamInterface< StreamTraits >& operator<<(OutStreamInterface< StreamTraits >& out,
...
/** \brief read a ReducedBasisSpace from an input stream
   ...
   */
template< class StreamTraits, class BaseFunctionType >
inline InStreamInterface< StreamTraits >& operator>>(InStreamInterface< StreamTraits >& in,
...
#endif // ifndef DUNE_RB_REDUCEDBASISSPACE_REDUCEDBASISSPACE_INLINE_HH
