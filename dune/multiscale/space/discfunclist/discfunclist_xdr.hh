...
class DiscreteFunctionList_xdr : public
...
private:
     ...
     *  \param[in] create  boolean flag indicating wether the discrete function list shall be created newly.
     */
    DiscreteFunctionList_xdr(const DiscreteFunctionSpaceType &discFuncSpace, int length, std::string name="discFuncs", const bool create=false)
      : dataPath_("./" + name + "/" ),
        discFuncSpace_(discFuncSpace),
        cleared_(false)
    {
