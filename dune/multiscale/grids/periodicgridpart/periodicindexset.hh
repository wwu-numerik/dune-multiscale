...
protected:
  ...
  static field dist2(const FieldVector< field, dim >& u, const FieldVector< field, dim >& v);

  template< class field, int dim >
  static void truncate(FieldVector< field, dim >& v);
  template< class field, int dim >
  static void truncate(FieldVector< field, dim >& v, FieldVector< field, dim >& w);
...
template< class Grid >
template< class Entity >
inline bool PeriodicLeafIndexSet< Grid >::contains(const Entity& entity) const {
...
template< class Grid >
inline typename PeriodicLeafIndexSet< Grid >::IndexType PeriodicLeafIndexSet< Grid >::size(int codim) const {
  if (codim == 0)
...
template< class Grid >
template< class field, int dim >
inline field PeriodicLeafIndexSet< Grid >
...
template< class Grid >
template< class field, int dim >
inline void PeriodicLeafIndexSet< Grid >::truncate(FieldVector< field, dim >& v) {
  for (int i = 0; i < dim; ++i)
    v[i] -= floor(v[i]);
}
...
template< class Grid >
template< class field, int dim >
inline void PeriodicLeafIndexSet< Grid >
...
template< class Grid >
inline typename PeriodicLeafIndexSet< Grid >::IndexType PeriodicLeafIndexSet< Grid >
...
#endif // ifndef DUNE_FEM_PERIODICINDEXSET_HH
