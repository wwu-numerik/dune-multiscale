...
class ConstantDiffusionMatrix : public Dune::Fem::Function<Dune::Multiscale::CommonTraits::FunctionSpaceType,
...
public:
  inline explicit ConstantDiffusionMatrix(const FieldMatrixType& A_given_values) : A_values_(A_given_values) {}
  ...
  void jacobianDiffusiveFlux(const DomainType&, const JacobianRangeType&, const JacobianRangeType&,
