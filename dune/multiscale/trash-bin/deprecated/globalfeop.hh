...
/*======================================================================*/
  ...
  {
    //diese Funktion muss vorhanden, liegt aber auf Eis, das heißt hier passiert nichts für unser Beispiel. Sie könnte genauso gut leer sein. 
...
protected:
                          ...
                          LocalMatrixImp &mat ) const
    {
      ...
      //the BaseSet is always local. It denotes the set of base functions that are not equal to zero on a current entity. Therefor 'numBaseFunctions()' simply yields the number of elements of such a set (not the global number of base functions)
