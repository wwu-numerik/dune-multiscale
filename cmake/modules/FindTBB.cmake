...
SET_IF_EMPTY(TBBROOT "$ENV{TBBROOT}")
...
FILE(GLOB _path ${TBBROOT}/build/*_release)
...
FILE(GLOB _path ${TBBROOT}/build/*_debug)
...
IF(TBB_FOUND)
  ...
  MARK_AS_ADVANCED(TBBROOT)
ELSE()
  SET(TBBROOT "" CACHE PATH
